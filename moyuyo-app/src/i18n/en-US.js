...
export default {
  ...
  userCenter: {
    ...
    profileTabCollected: 'Saved',
    profileEmptyPosts: 'No posts yet. Share your first one!',
    profileEmptyLiked: 'No liked posts yet',
    profileEmptyCollected: 'No saved posts yet',
    profileLoadMore: 'Load more',
    profileLoadDone: 'No more',
    profileLoadFailed: 'Load failed. Pull down to retry.',
    // bio editing: tap bio to open action sheet (Edit bio / Clear bio)
    profileBioEdit: 'Edit bio',
    profileBioClear: 'Clear bio',
  ...
  followList: {
    ...
    followed: 'Following',
    // 「我关注的」列表右侧按钮文案：点击 = 取消关注当前用户（带二次确认）

  ...
  <view v-if="product" class="detail">
    <scroll-view scroll-y class="scroll">
      ...
      <view class="section card">
        <view class="reviews-header">
          ...
          <text class="arrow" @click="seeAllReviews">See All <text class="luc luc-chevron-right"></text></text>
        </view>
        ...
        <view v-for="r in reviews.slice(0, 2)" :key="r.id" class="review-item">
          <view class="review-head">
            ...
            <text class="review-rating"><text class="luc luc-star"></text> {{ r.rating }}</text>
          </view>
    ...
    <view class="bottom-bar safe-area-bottom">
      <view class="bar-icon" @click="goCart">
        <text class="bar-emoji"><text class="luc luc-shopping-cart"></text></text>
      ...
      <view class="bar-icon" @click="onWishToggle">
        <text class="bar-emoji luc" :class="$luc(wishlisted  ?  'heart'  :  'heart')"></text>
        <text class="bar-label">Wishlist</text>
      </view>
      <view class="bar-icon" @click="onService">
        <text class="bar-emoji"><text class="luc luc-message-circle"></text></text>

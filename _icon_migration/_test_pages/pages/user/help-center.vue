<template>
  <view class="help-center">
    <view class="page-header">
      <view class="back" @click="goBack"><text class="luc luc-arrow-left"></text></view>
      ...
      <view v-else class="faq-list">
        <view v-for="(f, i) in filteredFAQ" :key="f.id" class="faq-item" @click="toggleFaq(i)">
          <view class="faq-q">
            ...
            <text class="faq-arrow" :class="{ rotated: f.expanded }"><text class="luc luc-chevron-right"></text></text>
          </view>
          <view v-if="f.expanded" class="faq-a">
            ...
            <view class="faq-helpful">
              ...
              <view class="helpful-btn" @tap.stop="vote(f, true)"><text class="luc luc-thumbs-up"></text> 有帮助</view>
              <view class="helpful-btn no" @tap.stop="vote(f, false)"><text class="luc luc-thumbs-down"></text> 没解决</view>
            </view>
          </view>
        </view>
      </view>

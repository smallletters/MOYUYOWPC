...
// TODO: 仓库管理、海外仓、合包/分包裹、承运商对比等模块需要创建对应表和 Mapper 后实现
public class AdminLogisticsController {
  ...
  // TODO: 需要创建 warehouse 表和 Mapper 后实现
  ...
  @GetMapping("/overseas")
  // TODO: 需要创建 overseas_warehouse 表和 Mapper 后实现
  ...
  // TODO: 需要创建 merge_package 表和 Mapper 后实现
  ...
  // TODO: 需要创建 split_package 表和 Mapper 后实现
  ...
  @GetMapping("/carriers")
  // TODO: 需要创建 carrier 表和 Mapper 后实现
  ...
  // TODO: 需要创建 clearance 表和 Mapper 后实现
  ...
  @GetMapping("/customs")
  // TODO: 需要创建 customs 表和 Mapper 后实现
  ...
  // TODO: 需要创建 shipping_strategy 表和 Mapper 后实现

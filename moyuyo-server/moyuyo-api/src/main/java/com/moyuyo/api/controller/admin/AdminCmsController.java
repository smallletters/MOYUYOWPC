...
public class AdminCmsController {
    ...
    public Result<List<Map<String, Object>>> list(@RequestParam(defaultValue = "BANNER") String type,
        ...
        try {
            ...
            List<Map<String, Object>> pageRecords = start < list.size() ? list.subList(start, end) : new ArrayList<>();
            return Result.success(pageRecords);
        } catch (Exception e) {
            return Result.error("获取CMS列表失败: " + e.getMessage());
        }
    }
    ...
    public Result<Map<String, Object>> create(@RequestBody Map<String, Object> body) {
        try {
            ...
            return Result.error("新建内容失败: " + e.getMessage());
        }
    }
    ...
    public Result<Map<String, Object>> reorder(@RequestBody List<Map<String, Object>> orders) {
        try {
            ...
            return Result.error("拖拽排序失败: " + e.getMessage());
        }
    }
}

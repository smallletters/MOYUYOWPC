...
ALTER TABLE mo_address
  ...
  ADD COLUMN created_at  DATETIME    NULL COMMENT '创建时间',
...
ALTER TABLE mo_community_post
  ADD COLUMN likes      INT          NOT NULL DEFAULT 0  COMMENT '点赞数',
  ADD COLUMN comments   INT          NOT NULL DEFAULT 0  COMMENT '评论数',
  ADD COLUMN deleted    TINYINT(1)   NOT NULL DEFAULT 0  COMMENT '逻辑删除 0-正常 1-已删',
...
ALTER TABLE mo_user_coupon
  ADD COLUMN used_time     DATETIME  NULL COMMENT '使用时间',
  ADD COLUMN used_order_id BIGINT    NULL COMMENT '使用订单ID',
  ADD COLUMN create_time   DATETIME  NULL COMMENT '创建时间';

-- 4) mo_gift_card：实体映射 pin
ALTER TABLE mo_gift_card
  ADD COLUMN pin VARCHAR(64) NULL COMMENT '卡密';
...
ALTER TABLE mo_pet
  ADD COLUMN species     VARCHAR(32)  NULL COMMENT '物种',
  ADD COLUMN weight      DECIMAL(5,2) NULL COMMENT '体重(kg)',
  ADD COLUMN notes       VARCHAR(512) NULL COMMENT '备注',
  ADD COLUMN deleted     TINYINT(1)   NOT NULL DEFAULT 0 COMMENT '逻辑删除 0-正常 1-已删',
  ADD COLUMN created_at  DATETIME     NULL COMMENT '创建时间',
  ADD COLUMN updated_at  DATETIME     NULL COMMENT '更新时间';

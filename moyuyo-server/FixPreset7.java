...
public class FixPreset7 {
  public static void main(String[] a) throws Exception {
    ...
    try (Connection c = DriverManager.getConnection(url);
         ...
         ResultSet rs = s.executeQuery("SELECT config_key, config_value FROM mo_system_config WHERE config_group='security' ORDER BY config_key")) {
      while (rs.next()) {

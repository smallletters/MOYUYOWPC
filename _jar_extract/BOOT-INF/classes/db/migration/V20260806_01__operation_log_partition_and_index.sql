...
-- 使用 ADD INDEX IF NOT EXISTS 形式（MySQL 8.0.29+），更早版本请手工忽略已存在错误
ALTER TABLE `mo_operation_log` ADD INDEX IF NOT EXISTS `idx_oplog_success_time` (`success`, `create_time`);

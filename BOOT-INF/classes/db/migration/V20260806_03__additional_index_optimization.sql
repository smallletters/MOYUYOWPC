...
ALTER TABLE `mo_flash_sale` ADD INDEX IF NOT EXISTS `idx_flash_sale_status_time` (`active`, `start_time`);

-- 8. 退款工作台：mo_refund 没有 update_time 列，使用 complete_time 列替代
ALTER TABLE `mo_refund` ADD INDEX IF NOT EXISTS `idx_refund_status_update` (`status`, `complete_time`);
